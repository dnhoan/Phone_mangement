...
public interface ILoaiSanPhamService {
    ...
    String SELECT_BY_ID = "SELECT MaSP, TenSP, DongSP.MaDong, TenDong, HangSanPham.MaHang, TenHang, SanPham.trangthai FROM SanPham JOIN \n"
    ...
    String SELECT_BY_ID_DONG = "SELECT MaSP, TenSP, DongSP.MaDong, TenDong, HangSanPham.MaHang, TenHang, SanPham.trangthai FROM SanPham JOIN \n"
            + "DongSP ON DongSP.MaDong = SanPham.MaDong JOIN\n"
    ...
    String SELECT_BY_KEYWORD = "SELECT MaSP, TenSP, DongSP.MaDong, TenDong, HangSanPham.MaHang, TenHang, SanPham.trangthai FROM SanPham JOIN \n"
            + "DongSP ON DongSP.MaDong = SanPham.MaDong JOIN\n"
            + "HangSanPham ON DongSP.MaHang = HangSanPham.MaHang WHERE SANPHAM.TrangThai = 1 AND TenSP LIKE ?";
    String SELECT_RECYCLE = "SELECT MaSP, TenSP, DongSP.MaDong, TenDong, HangSanPham.MaHang, TenHang, SanPham.trangthai FROM SanPham JOIN \n"
            + "DongSP ON DongSP.MaDong = SanPham.MaDong JOIN\n"
