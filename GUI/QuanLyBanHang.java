...
public void changeColor(JButton hover, Color rand) {
    ...
    private void initComponents() {
        ...
        jpnSanPhamLayout.setVerticalGroup(
            jpnSanPhamLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(jScrollPane9, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 353, Short.MAX_VALUE)
        );
...
//        MainThuNghiem.dashboardview.add(kh).setVisible(true);
    ...
    private void btnSwichDanhsachMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnSwichDanhsachMouseEntered
        changeColor(btnSwichDanhsach, new Color(102, 0, 102));
    }//GEN-LAST:event_btnSwichDanhsachMouseEntered

    private void btnSwichDanhsachMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnSwichDanhsachMouseExited
         changeColor(btnSwichDanhsach, new Color(25, 29, 74));
    }//GEN-LAST:event_btnSwichDanhsachMouseExited

    private void editKhachHangMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_editKhachHangMouseEntered
           changeColor(editKhachHang, new Color(102, 0, 102));
    }//GEN-LAST:event_editKhachHangMouseEntered

    private void editKhachHangMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_editKhachHangMouseExited
        changeColor(editKhachHang, new Color(25, 29, 74));
    }//GEN-LAST:event_editKhachHangMouseExited

    private void btnThanhToanMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnThanhToanMouseEntered
         changeColor(btnThanhToan, new Color(102, 0, 102));
    ...
    private void btnThanhToanMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnThanhToanMouseExited
        changeColor(btnThanhToan, new Color(25, 29, 74));
    }//GEN-LAST:event_btnThanhToanMouseExited

    private void btnLuuHoaDonMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnLuuHoaDonMouseEntered
         changeColor(btnLuuHoaDon, new Color(102, 0, 102));
    }//GEN-LAST:event_btnLuuHoaDonMouseEntered

    private void btnLuuHoaDonMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnLuuHoaDonMouseExited
          changeColor(btnLuuHoaDon, new Color(25, 29, 74));
    }//GEN-LAST:event_btnLuuHoaDonMouseExited

    private void btnInHoaDonMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnInHoaDonMouseEntered
          changeColor(btnInHoaDon, new Color(102, 0, 102));
    ...
    private void btnInHoaDonMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnInHoaDonMouseExited
           changeColor(btnInHoaDon, new Color(25, 29, 74));
    }//GEN-LAST:event_btnInHoaDonMouseExited

    private void btnNewReceip2MouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnNewReceip2MouseExited
         changeColor(btnNewReceip2, new Color(25, 29, 74));
    }//GEN-LAST:event_btnNewReceip2MouseExited

    private void btnNewReceip2MouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnNewReceip2MouseEntered
       changeColor(btnNewReceip2, new Color(102, 0, 102));
    }//GEN-LAST:event_btnNewReceip2MouseEntered

    private void btnDescMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnDescMouseEntered
        changeColor(btnDesc, new Color(102, 0, 102));
    }//GEN-LAST:event_btnDescMouseEntered

    private void btnDescMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnDescMouseExited
          changeColor(btnDesc, new Color(25, 29, 74));
    }//GEN-LAST:event_btnDescMouseExited

    private void btnAscenMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnAscenMouseEntered
       changeColor(btnAscen, new Color(102, 0, 102));
    }//GEN-LAST:event_btnAscenMouseEntered

    private void btnAscenMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnAscenMouseExited
           changeColor(btnAscen, new Color(25, 29, 74));
    }//GEN-LAST:event_btnAscenMouseExited

    private void btnExportexcelMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnExportexcelMouseEntered
      changeColor(btnExportexcel, new Color(102, 0, 102));
    ...
    changeColor(btnExportexcel, new Color(25, 29, 74));
