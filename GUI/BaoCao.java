...
public class BaoCao extends javax.swing.JFrame {
    ...
    public void run() {
        ...
        try {
            ...
            String message = "Báo cáo sếp! \n" + " Doanh thu và tổng sản phẩm bán được trong tháng " + thang + " là: " + soluong  + " máy \nDoanh thu trong tháng: " + UtilityService.toVnd(doanhthu);//+ randomCode;
            ...
            transport.close();
            JOptionPane.showMessageDialog(null, "Thông tin doanh thu đã được gửi đến email của bạn mời bạn kiểm tra");
        } catch (Exception e) {
            e.printStackTrace();
