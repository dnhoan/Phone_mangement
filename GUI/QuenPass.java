...
public class QuenPass extends javax.swing.JFrame {
    ...
    private void btnXacNhanMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnXacNhanMouseEntered
        changeColor(btnXacNhan, new Color(102, 0, 102));
    ...
    private void btnXacNhanMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnXacNhanMouseExited
        changeColor(btnXacNhan, new Color(25, 29, 74));
    ...
    private void btnQuaylaiMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnQuaylaiMouseEntered
        changeColor(btnQuaylai, new Color(102, 0, 102));
    ...
    private void btnQuaylaiMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnQuaylaiMouseExited
        changeColor(btnQuaylai, new Color(25, 29, 74));
